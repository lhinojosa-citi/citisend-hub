...
function renderProjectPage(){
  ...
  setText('kpiPhotos', project.fotografias || 0);
...
function renderGallery(project){
  ...
  box.innerHTML = `
    <div class="gallery-placeholder">
      ...
      <p>Las imágenes se añadirán en <strong>${project.galeria || 'proyectos/' + project.id + '/galeria/'}</strong>.</p>
      <a href="#adminNote" class="btn secondary">Cómo añadir fotos</a>
    </div>
  `;
}
